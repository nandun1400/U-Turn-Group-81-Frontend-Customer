...
Future<void> handle_Save_vehicle_rental(Vehicle dummyData) async {


  // TODO: API call to signup
  try {
    var response = await http.post(
      Uri.parse('${globalData.baseUrlRoute}/save_vehicle_rental'),
      body: jsonEncode({
...
class CompletionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    vehicle.priceInDollars = finalPrice;
    vehicle.numberOfVehiclesAvailable = numberOfVehicles;
    handle_Save_vehicle_rental(vehicle); //TODO: API call
    return Scaffold(
